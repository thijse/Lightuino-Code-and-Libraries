/*
  MovingWordMatrix.h - MovingWordMatrix library
...
{	  	
	private:
		...
		int currMin;
		int currHour;
		void moveWord(const unsigned char fromWord[], const unsigned char toWord[]);
		void MoveTime(int currHour, int currMinute);
	...
	public:			
		MovingWordMatrix(lightuinoAnimatedMatrix& _matrix);
