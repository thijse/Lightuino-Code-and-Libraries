...
class LightuinoSink
 {
  ...
  LightuinoSink(uint8_t clockPin=Lightuino_CLOCK_PIN,uint8_t serDataPin1=Lightuino_SER_DATA_LEFT_PIN,uint8_t serDataPin2=Lightuino_SER_DATA_RIGHT_PIN,uint8_t brightPin=Lightuino_BRIGHTNESS_PIN);
...
class CCShield:public LightuinoSink
{
 public:
  //?<ctor>Constructor takes all of the pins needed.</ctor>
 CCShield(uint8_t clockPin,uint8_t serDataPin1,uint8_t serDataPin2,uint8_t brightPin):LightuinoSink(clockPin,serDataPin1,serDataPin2,brightPin) {};
...
class Lightuino:public LightuinoSink
{
 public:
  //?<ctor>Constructor takes all of the pins needed.</ctor>
 Lightuino(uint8_t clockPin,uint8_t serDataPin1,uint8_t serDataPin2,uint8_t brightPin):LightuinoSink(clockPin,serDataPin1,serDataPin2,brightPin) {};
